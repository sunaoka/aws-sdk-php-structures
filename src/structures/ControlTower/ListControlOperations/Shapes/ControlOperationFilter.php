 ...
 * @property list<'ENABLE_CONTROL'|'DISABLE_CONTROL'|'UPDATE_ENABLED_CONTROL'>|null $controlOperationTypes
...
class ControlOperationFilter extends Shape
{
     ...
     *     controlOperationTypes?: list<'ENABLE_CONTROL'|'DISABLE_CONTROL'|'UPDATE_ENABLED_CONTROL'>|null,
