 ...
 * @property list<'Rightsize'|'Stop'|'Upgrade'|'PurchaseSavingsPlans'|'PurchaseReservedInstances'|'MigrateToGraviton'>|null $actionTypes
...
class Filter extends Shape
{
     ...
     *     actionTypes?: list<'Rightsize'|'Stop'|'Upgrade'|'PurchaseSavingsPlans'|'PurchaseReservedInstances'|'MigrateToGraviton'>|null,
     *     tags?: list<Tag>|null,
