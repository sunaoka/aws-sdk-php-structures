 ...
 * @property 'AV1'|'AVC_INTRA'|'FRAME_CAPTURE'|'H_264'|'H_265'|'MPEG2'|'PASSTHROUGH'|'PRORES'|'VC3'|'VP8'|'VP9'|'XAVC'|null $Codec
...
class VideoCodecSettings extends Shape
{
     ...
     *     Codec?: 'AV1'|'AVC_INTRA'|'FRAME_CAPTURE'|'H_264'|'H_265'|'MPEG2'|'PASSTHROUGH'|'PRORES'|'VC3'|'VP8'|'VP9'|'XAVC'|null,
