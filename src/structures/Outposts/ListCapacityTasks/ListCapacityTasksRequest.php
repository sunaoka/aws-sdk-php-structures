 ...
 * @property list<'REQUESTED'|'IN_PROGRESS'|'FAILED'|'COMPLETED'|'CANCELLED'>|null $CapacityTaskStatusFilter
 */
class ListCapacityTasksRequest extends Request
{
     ...
     *     CapacityTaskStatusFilter?: list<'REQUESTED'|'IN_PROGRESS'|'FAILED'|'COMPLETED'|'CANCELLED'>|null
     * } $args
     */
