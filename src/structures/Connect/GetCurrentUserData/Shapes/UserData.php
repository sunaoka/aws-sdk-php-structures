 ...
 * @property array<'VOICE'|'CHAT'|'TASK', int<0, max>>|null $AvailableSlotsByChannel
 * @property array<'VOICE'|'CHAT'|'TASK', int<0, max>>|null $MaxSlotsByChannel
 * @property array<'VOICE'|'CHAT'|'TASK', int<0, max>>|null $ActiveSlotsByChannel
...
class UserData extends Shape
{
     ...
     *     AvailableSlotsByChannel?: array<'VOICE'|'CHAT'|'TASK', int<0, max>>|null,
     *     MaxSlotsByChannel?: array<'VOICE'|'CHAT'|'TASK', int<0, max>>|null,
     *     ActiveSlotsByChannel?: array<'VOICE'|'CHAT'|'TASK', int<0, max>>|null,
