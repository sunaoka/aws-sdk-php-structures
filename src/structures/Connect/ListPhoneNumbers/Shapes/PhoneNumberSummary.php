 ...
 * @property 'TOLL_FREE'|'DID'|'UIFN'|'SHARED'|'THIRD_PARTY_TF'|'THIRD_PARTY_DID'|null $PhoneNumberType
...
class PhoneNumberSummary extends Shape
{
     ...
     *     PhoneNumberType?: 'TOLL_FREE'|'DID'|'UIFN'|'SHARED'|'THIRD_PARTY_TF'|'THIRD_PARTY_DID'|null,
