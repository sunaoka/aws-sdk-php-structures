 ...
 * @property list<'TOLL_FREE'|'DID'|'UIFN'|'SHARED'|'THIRD_PARTY_TF'|'THIRD_PARTY_DID'>|null $PhoneNumberTypes
...
class ListPhoneNumbersRequest extends Request
{
     ...
     * @param array{
     *     InstanceId: string,
     *     PhoneNumberTypes?: list<'TOLL_FREE'|'DID'|'UIFN'|'SHARED'|'THIRD_PARTY_TF'|'THIRD_PARTY_DID'>|null,
